...
/* INTR, INTE, INTF and INTS share this layout.*/
#define POWMAN_INT_PWRUP_WHILE_WAITING_Pos 3U
#define POWMAN_INT_PWRUP_WHILE_WAITING_Msk (1U << POWMAN_INT_PWRUP_WHILE_WAITING_Pos)
#define POWMAN_INT_PWRUP_WHILE_WAITING    POWMAN_INT_PWRUP_WHILE_WAITING_Msk
#define POWMAN_INT_STATE_REQ_IGNORED_Pos  2U
#define POWMAN_INT_STATE_REQ_IGNORED_Msk  (1U << POWMAN_INT_STATE_REQ_IGNORED_Pos)
#define POWMAN_INT_STATE_REQ_IGNORED      POWMAN_INT_STATE_REQ_IGNORED_Msk
#define POWMAN_INT_TIMER_Pos              1U
#define POWMAN_INT_TIMER_Msk              (1U << POWMAN_INT_TIMER_Pos)
#define POWMAN_INT_TIMER                  POWMAN_INT_TIMER_Msk
#define POWMAN_INT_VREG_OUTPUT_LOW_Pos    0U
#define POWMAN_INT_VREG_OUTPUT_LOW_Msk    (1U << POWMAN_INT_VREG_OUTPUT_LOW_Pos)
#define POWMAN_INT_VREG_OUTPUT_LOW        POWMAN_INT_VREG_OUTPUT_LOW_Msk
/** @} */
